    ...
    if (have_posts()) :
        ...
        while (have_posts()) :
            ...
            if (bbp_is_forum_archive()) {
                echo "<p class='form-text-below-heading'><strong>To post a question or start a discussion, click on the category below that best fits your topic — fertility, pregnancy, parenting or wellbeing.</strong> </p><p>Once you're in, you'll find the option to create your post. Ask a question, share your story, or offer advice.</p>";
