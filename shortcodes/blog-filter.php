    ...
    if (current_user_can('administrator')) {
        ...
        foreach ($recent_posts as $post) {
            ...
            if ($format == "post-page" && !empty($id_list)) {
                ...
                if (!$post_open_div) {
                    $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-1">';
                    $post_open_div = true;
                }
                ...
                if ((! isset($attr["post_type"]) || $attr["post_type"] != "videos/podcasts")  && ($design == "full-vid-list" || $design == "full-pod-list")) {
                    ...
                    if ($cnt == 4 || $cnt == 9) {
                        ...
                        if ($post_open_div) {
                            $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-2">';
                        }
                    }
                    ...
                    if (!$post_open_div) {
                        $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-3">';
                        $post_open_div = true;
                    }
                    ...
                    if (
                        ...
                        if (!$post_open_div) {
                            $rtn .= '<div class="blogs-loop-inner blogs-loop-inner-4 md-padding  mw-1500 trb-px">';
                            $post_open_div = true;
                        }
                        ...
                        if (! isset($attr["post_type"]) || ($attr["post_type"] != "expert_profiles" && $attr["post_type"] != "videos" && $attr["post_type"] != "videos/podcasts")) {
                            if ($in_count == 6) {
                                ...
                                $rtn .= '<div class="blogs-loop-watch-listen md-padding trb-px">';
                                ...
                                if (empty($post_type)) {
                                    ...
                                    $exp_count++;
                                    if ($post_open_div) {
                                        $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-5">';
                                    }
                                }
                                $cat_count++;
                                ...
                                if ($add_ad == "Yes") {
                                    ...
                                    if ($post_open_div) {
                                        $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-6 ">';
                                    }
                                } else {
                                    $add_ad = "Yes";
                                    ...
                                    if (get_post_type($post['ID']) == 'post') {
                                        ...
                                        $exp_count++;
                                        if ($post_open_div) {
                                            $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-7">';
                                        }
                                    }
                                }
                            }
                            ...
                            if ($in_count == 23) {
                                ...
                                $rtn .= do_shortcode("[display_followus]");
                                if ($post_open_div) {
                                    $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-8">';
                                }
                            } else if ($in_count == 29) {
                                if ($post_open_div) {
                                    $rtn .= '</div>';
                                ...
                                $rtn .= do_shortcode("[display_insider]");
                                if ($post_open_div) {
                                    $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-9">';
                                }
                            } else if ($in_count == 35) {
                                if ($post_open_div) {
                                    $rtn .= '</div>';
                                ...
                                if ($post_open_div) {
                                    $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-10">';
                                }
                            } else if ($in_count == 41) {
                                if ($add_ad == "Yes") {
                                    $add_ad = "No";
                                    ...
                                    $rtn .= do_shortcode("[ad_list]");
                                    if ($post_open_div) {
                                        $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-11">';
                                    }
                                } else {
                                    $add_ad = "Yes";
                                }
                        ...
                        if ($vid_count == 1 && $curtotal == 0 && (! isset($attr["post_type"]) || $attr["post_type"] != "videos" && $attr["post_type"] != "videos/podcasts")) {
                            ...
                            if ($post_open_div) {
                                $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-12">';
                            }
                        }
                        ...
                        if (
                            ...
                            if ($post_open_div) {
                                $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-13">';
                            }
                        }
                        ...
                        if ($curtotal == 0 && $cat_count == 1) {
                            ...
                            if ($attr["post_type"] == "expert_profiles") {
                                ...
                                $rtn .= do_shortcode("[category_list page='experts']");
                                if ($post_open_div) {
                                    $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-14 ">';
                                }
                                ...
                                $rtn .= do_shortcode("[category_list page='videos']");
                                if ($post_open_div) {
                                    $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-15">';
                                }
                                ...
                                if ($post_open_div) {
                                    $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-16">';
                                }
                            }
                        }
                        ...
                        if ($curtotal == 0 && $giveaway_count == 1 && ($cur_post_type == "giveaway-items" || $cur_post_type == "offer-items" || $cur_post_type == "offer-items/giveaway-items/events" || $cur_post_type == "events")) {
                            ...
                            if ($post_open_div) {
                                $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-17">';
                            }
                        }
            ...
            if ($format == "normal") {
                ...
                if (!$post_open_div) {
                    $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-19">';
                    $post_open_div = true;
                }
            ...
            if ($format == "normal-2") {
                ...
                if (!$post_open_div) {
                    $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-20">';
                    $post_open_div = true;
                }
            ...
            if ($format == "normal-3") {
                ...
                if (!$post_open_div) {
                    $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-23">';
                    $post_open_div = true;
                }
            ...
            if ($format == "normal-4") {
                ...
                if (!$post_open_div) {
                    $rtn .= '<div class="blogs-loop-inner md-padding  mw-1500 trb-px blogs-loop-inner-24">';
                    $post_open_div = true;
                }
