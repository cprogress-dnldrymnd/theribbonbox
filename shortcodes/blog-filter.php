...
function blog_filter_function($atts) {
    if(current_user_can('administrator')) {
        return blog_filter_function_v2($atts);
    } else {
        return blog_filter_function_v1($atts);
    }
}

function blog_filter_function_v1($atts)
{
    //var_dump($attr);
...
//----v2-func
function blog_filter_function_v2()
{
    //var_dump($attr);
