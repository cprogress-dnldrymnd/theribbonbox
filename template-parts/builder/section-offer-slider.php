            ...
            <div class="product-widget--outer" id="<?php echo esc_attr( $unique_id ); ?>">
                <div class="product-widget--inner">
                    ...
                    foreach ( $trb_ads as $ad ) :
                        ...
                        $ad_image_id = function_exists('get_field') ? get_field('first_image', $ad->ID) : 0;
                        $ad_link     = function_exists('get_field') ? get_field('first_image_link', $ad->ID) : '';
