        ...
        <div class="site-wrap">
            ...
            <header id="header-main-site" role="banner" style="background: rgba(255, 255, 255, 0.22);">
                ...
                <div class="head-inner">
                    <div class="head-sub">
                        <a href="#" class="show-search"><img src="<?php echo (get_template_directory_uri()) ?>/images/search.png" alt="Search"><span>SEARCH</span></a>
                        <a href="/subscribe" class="sub-pop-btn"><img src="<?php echo (get_template_directory_uri()) ?>/images/subscribe.png" alt="Subscribe"><span>SUBSCRIBE</span></a>
                        <a href="/community"><img src="<?php echo (get_template_directory_uri()) ?>/images/account.png" alt="Account"><span>LOG IN</span></a>
                    </div>
                    ...
                    <img class="m-menu" src="<?php echo (get_template_directory_uri()) ?>/images/icons/menu.png" alt="Menu">
                    <a class="logo-h-a" href="/">
                        <img class="logo" src="<?php echo (get_template_directory_uri()) ?>/images/logo-hdr-7.png" alt="The Ribbon Box">
                    </a>
                ...
                <nav>
                    ...
                    <div class="header-search header-search-mobile">
                        <div class="header-search-inner header-search-inner-mobile">
                            ...
                            <img id="h-search-close" class="h-search-close" src="<?php echo (get_template_directory_uri()) ?>/images/icons/menu-close.png" alt="Close">
                        </div>
                    </div>
                    <?php wp_nav_menu(
                        array(
                ...
                <div class="header-search header-search-v2 ?>">
                    <div class="header-search-inner">
                        ...
                        ?>
                        <img id="h-search-close1" class="h-search-close" src="<?php echo (get_template_directory_uri()) ?>/images/icons/menu-close.png" alt="Close">
                    </div>
                </div>
