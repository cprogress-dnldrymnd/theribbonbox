...
echo '<div data-template="index-events.php" class="blog-top-ban blog-top-ban-main-content"><div class="blog-l-img" '.$style.'><img src="/wp-content/themes/lighttheme/images/menu-trans-req.png"></div><div class="blog-l-text-out" '.$border.'><div class="blog-l-text blog-p-text" >'.$featured_cur.'';
...
if (!empty($website_link)){
    echo '<br><br><div style="text-transform:uppercase;" class="visit-links-ex"><a href="'.$website_link.'" target="_blank" class="button-expert">Register Now</a></div>';
}
