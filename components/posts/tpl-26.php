<?php
$rtn .= '
<div class="blog-tpl-26 blog-even-nor blog-nor format-' . $format . ' incount-' . $in_count . ' style-' . $styles_str . ' post-type-' . $this_post_type . ' blog-nor-with-bg-green blog-nor-with-bg-green-exp"><img class="blg-bg-col" src="/wp-content/themes/lighttheme/images/menu-trans-req.png">' .$featured_cur.'<div class="blog-l-img" '.$style.'>
