<?php
$rtn .= '
<div class="blog-tpl-27 blog-odd-nor blog-nor format-' . $format . ' incount-' . $in_count . ' style-' . $styles_str . ' post-type-' . $this_post_type . ' ">'.$featured_cur.'<div class="blog-l-text-out">
