<?php
$rtn .= '
<div class="blog-tpl-25 blog-top-ban format-' . $format . ' incount-' . $in_count . ' post-type-' . $this_post_type . '">
    <div class="blog-l-img" '.$style.'>
        ...
        <div class="blog-btns">
        <a href="'.get_permalink($post['ID']).'">'.$more_t_text.'</a>  |  <div style="display:inline-block;">'.create_item_socials(get_permalink($post['ID']), $post['post_title']).'</div>
        </div>
        </div>
    </div>
</div>';