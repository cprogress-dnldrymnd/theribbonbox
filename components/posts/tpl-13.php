<?php
$rtn .= '
<div class="blog-tpl-13 blog-even-nor blog-nor format-' . $format . ' incount-' . $in_count . ' post-type-' . $this_post_type . ' blog-nor-with-bg-green"><img class="blg-bg-col" src="/wp-content/themes/lighttheme/images/menu-trans-req.png">' .$featured_cur.'<div class="blog-l-img" '.$style.'>
