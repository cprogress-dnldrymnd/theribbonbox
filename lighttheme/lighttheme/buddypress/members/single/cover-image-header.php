...
<div id="cover-image-container">
	...
	<div id="item-header-cover-image">
		...
		<div id="item-header-content">
			...
			<div class="user--member-since"> <span class="username">@<?php bp_displayed_user_mentionname(); ?></span> / <span class="member-since">Member since <?= get_user_registration_year(bp_displayed_user_id()); ?> </span>  </div>
