...
?>
    <?php if ($social == 'all' || $social == 'icons-only' || $social == 'icons-only-all') {  ?>
        <div class="social--icons d-flex gap-3 align-items-center">
            ...
            <?php if ($social == 'icons-only-all') {  ?>
                <a class="d-flex gap-3 align-items-center" href="https://www.instagram.com/the.ribbon.box/" target="_blank">
