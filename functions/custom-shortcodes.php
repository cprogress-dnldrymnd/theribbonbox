...
?>
    ...
    <div class="social--icons social--icons-text d-flex gap-1 align-items-center my-3">
    ...
    <div class="social--icons social--icons-text d-flex gap-1 align-items-center mt-3">
